    ...
    <div className="w-full max-w-md">
      ...
      <div className="max-w-6xl mx-auto py-12 px-4">
        <div className="text-center">
          ...
          <h3 className="text-xl font-medium text-white mb-2">Chargement des abonnements...</h3>
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-4">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-white">{t('admin.modules.subscriptions.title')}</h1>
        <p className="text-gray-400">{t('admin.modules.subscriptions.description')}</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">
        ...
        <div className="flex gap-2">
          ...
          >
            <ToggleGroupItem value="all" className="px-2 py-1 text-xs">Tous plans</ToggleGroupItem>
            <ToggleGroupItem value="basic" className="px-2 py-1 text-xs">Basic</ToggleGroupItem>
            <ToggleGroupItem value="premium" className="px-2 py-1 text-xs">Premium</ToggleGroupItem>
            <ToggleGroupItem value="entreprise" className="px-2 py-1 text-xs">Entreprise</ToggleGroupItem>
          </ToggleGroup>
          ...
          >
            ...
            <ToggleGroupItem value="active" className="px-2 py-1 text-xs">Actifs</ToggleGroupItem>
            <ToggleGroupItem value="inactive" className="px-2 py-1 text-xs">Inactifs</ToggleGroupItem>
          </ToggleGroup>
        </div>
      </div>
          ...
          <CardContent className="py-12 text-center">
            ...
            <p className="text-gray-400">
              {planFilter === 'all' && statusFilter === 'all'
                ? t('admin.subscriptions.no_active')
                      ...
                      <button
                        onClick={async () => {
                          if (confirm('Désactiver cet abonnement ?')) {
                            const res = await fetch(`/api/admin/subscriptions/${sub.id}/deactivate`, {
                              method: 'POST',
                            });
                            if (res.ok) {
          ...
          {totalPages > 1 && (
            <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="text-sm text-gray-400">
                Page {currentPage} sur {totalPages} ({filteredAndSorted.length} abonnements)
              </div>
